...
QUnit.module("HTMLBars {{outlet}} helpers", {

  setup: function() {
    Ember.View.defaultTemplateEnv = defaultEnv;

    originalOutletHelper = defaultEnv.helpers.outlet;
  ...
  teardown: function() {
    delete defaultEnv.helpers.outlet;
    defaultEnv.helpers.outlet = originalOutletHelper;
